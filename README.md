...
- blind-navigation/ → Navigation module
- LinkAble Connect/ → Communication module
- reports/ → Documentation and reports

## 12. Documentation

All project documentation is available in the `Reports/` folder.

##  Author
Mishara Pathirana - misharapathirana@gmail.com
